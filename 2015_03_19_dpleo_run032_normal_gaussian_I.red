...
scale = 0.450 # scale, arcsec per unbinned pixel

ldevice = 1/xs # PGPLOT plot device for light curve plots
#ldevice = 2015_03_19_dpleo_run032_normal_gaussian_I.ps/cps # PGPLOT plot device for light curve plots
...
fit_half_width = 6 # for fit, unbinned pixels
...
[extraction]
1 = variable normal 1.50 5.0 15.0 2.5 20.0 30.0 3.0 32.0 45.0
...
# Next lines were automatically added by rupdate
fmap = # Fringe map, blank to ignore
